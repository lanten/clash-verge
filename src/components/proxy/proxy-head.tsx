  ...
  return (
    <Box sx={{ display: "flex", alignItems: "center", gap: 0.5, ...sx }}>
      ...
      <IconButton
        size="small"
        color="inherit"
        title={t("Delay check URL") as string}
        onClick={() =>
      ...
      <IconButton
        size="small"
        color="inherit"
        title={t("Proxy detail") as string}
      ...
      {textState === "filter" && (
        <TextField
          ...
          size="small"
          variant="outlined"
          placeholder={t("Filter conditions") as string}
      ...
      {textState === "url" && (
        <TextField
          ...
          size="small"
          variant="outlined"
          placeholder={t("Delay check URL") as string}
